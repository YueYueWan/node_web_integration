 ...
 * @version: 
 * @Author: maoyueer
 * @Date: 2022-12-15 17:02:19
 * @LastEditors: maoyueer
 * @LastEditTime: 2022-12-15 17:02:19
 */
// 测试图书馆代码
// import models
...
function userCreate(username, password, status, create_time, admin, city, cb) {
  userdetail = {
    username: username,
    password: password,
    status: status,
...
function createUsers(cb) {
  async.parallel([
    function (callback) {
      userCreate('admin', '123456', '1', '2022/12/15', 1, 'hangzhou', callback);
    },
    function (callback) {
      userCreate('other', '123456', '0', '2022/12/15', 1, 'hangzhou', callback);
    },
  ],
    // optional callback
    cb);
